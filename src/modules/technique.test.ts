...
describe('formatIngredientName', () => {
  ...
  describe('application technique', () => {
    it('should format float application', () => {
      ...
      expect(formatIngredientName(ingredient)).toBe('float rum');
    });
    ...
    it('should format rinse application', () => {
      ...
      expect(formatIngredientName(ingredient)).toBe('rinse absinthe');
    });
    ...
    it('should format top application', () => {
      ...
      expect(formatIngredientName(ingredient)).toBe('top cream');
    });
  });
